...
export function Tripod(props: IObjectProps) {
  ...
  const descripiton =
    {
      "멀티 프로브 수질 계측 센서":
        "수온, 용존산소, 염도, pH, 전기전도도, ORP, 산화환원전위, 탁도 등의 지표를 최소 1초 간격으로 동시에 측정하여 RS485 MODBUS, SDI12 프로토콜을 통해 데이터 교환을 제공합니다.",
      "단일 센서 (용존산소)":
        "수온, 용존산소, 염도, pH, 클로로필II, BGA 등 다양한 지표의 측정을 지원합니다. 본 자료의 센서는 용존산소와 수온 동시 계측 단일 센서입니다.",
      "단일 센서 (염도)":
        "수온, 용존산소, 염도, pH, 클로로필II, BGA 등 다양한 지표의 측정을 지원합니다. 본 자료의 센서는 염도와 수온 동시 계측 단일 센서입니다.",
    }[props.hovered] ??
    `${
