...
export function Model(props) {
  const { nodes, materials } = useGLTF("/modeling/test.glb");
  ...
  const descripiton =
    {
      ...
      본체: "이거슨 본체입니다. 멋지죠? 저도 멋지다고 생각합니다. 알루미늄으로 만들어졌어요. 내부에 배터리하고 센서가 들어가 있어서 소듕하게 다뤄야해요. 아시겠죠?",
      안테나:
        "이거슨 안테나입니다. 멋지죠? 저도 멋지다고 생각합니다. 그렇게 보이지는 않지만 안테나 맞아요.",
    }[props.hovered] ?? "마우스를 올려서 하드웨어의 정보를 확인하세요.";
